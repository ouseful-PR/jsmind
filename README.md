...
Jupyter-server-proxy wrapper for js-mind

TO DO:

- simple jupyter-server-proxy widget to deliver jsmind via simple http server;
- easy way to use jsmind to render mindmap from json description file.
